              ...
              <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
                  <div className="flex items-center mb-2">
                    <RiDatabaseLine className="text-blue-600 dark:text-blue-400 mr-2" size={20} />
                    <span className="font-medium text-blue-800 dark:text-blue-300">Demo Connection</span>
                  </div>
                      ...
                      {databaseSchema ? (
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center space-x-2 text-sm sticky top-0 bg-gray-50 dark:bg-gray-800/50 py-2 border-b border-gray-200 dark:border-gray-700 mb-2">
                            ...
                            <RiDatabaseLine className="text-blue-600 dark:text-blue-400" size={16} />
          ...
          >
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {/* File Upload Option */}
                <div 
                  className="bg-white dark:bg-dark-800 rounded-xl shadow-lg p-6 cursor-pointer transition-all duration-300 hover:shadow-xl border-2 border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-700"
                  onClick={() => {
